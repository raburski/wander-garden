...
const COPY = `
Wander Garden is a simple web-app that helps you make sense of your travel history. We connect to various data sources and present them in a cohesive form.
